...
#include "sdk_fx_shared.h"
	...
	#define CWeaponShotgunFD2 C_WeaponShotgunFD2
...
class CWeaponShotgunFD2 : public CWeaponSDKBase
{
public:
	DECLARE_CLASS( CWeaponShotgunFD2, CWeaponSDKBase );
	...
	virtual SDKWeaponID GetWeaponID( void ) const		{ return SDK_WEAPON_SHOTGUN_FD2; }
	virtual float GetWeaponSpread() { return 0.005f; } // AM; this weapon is VERY accurate


private:

	CWeaponShotgunFD2( const CWeaponShotgunFD2 & );
...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponShotgunFD2, DT_WeaponShotgunFD2 )

BEGIN_NETWORK_TABLE( CWeaponShotgunFD2, DT_WeaponShotgunFD2 )
...
BEGIN_PREDICTION_DATA( CWeaponShotgunFD2 )
#ifdef CLIENT_DLL
	DEFINE_PRED_FIELD( m_iInSpecialReload, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
#endif
END_PREDICTION_DATA()

LINK_ENTITY_TO_CLASS( weapon_shotgun_fd2, CWeaponShotgunFD2 );
PRECACHE_WEAPON_REGISTER( weapon_shotgun_fd2 );



CWeaponShotgunFD2::CWeaponShotgunFD2()
{
	m_flPumpTime = 0;
	m_iClip2 = 1;
}

void CWeaponShotgunFD2::PrimaryAttack()
{
...
void CWeaponShotgunFD2::SecondaryAttack()
{	
	CSDKPlayer *pPlayer = GetPlayerOwner();
	if ( !pPlayer )
		return;
...
void CWeaponShotgunFD2::WeaponIdle()
{
	CSDKPlayer *pPlayer = GetPlayerOwner();
...
bool CWeaponShotgunFD2::ReloadOrSwitchWeapons( void )
{
...
acttable_t CWeaponShotgunFD2::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE( CWeaponShotgunFD2 );
