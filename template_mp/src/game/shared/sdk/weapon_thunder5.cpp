...
#include "sdk_fx_shared.h"
	...
	#define CWeaponThunder5 C_WeaponThunder5
...
class CWeaponThunder5 : public CWeaponSDKBase
{
public:
	DECLARE_CLASS( CWeaponThunder5, CWeaponSDKBase );
...
private:
	...
	CWeaponThunder5( const CWeaponThunder5 & );
...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponThunder5, DT_WeaponThunder5 )

BEGIN_NETWORK_TABLE( CWeaponThunder5, DT_WeaponThunder5 )
...
BEGIN_PREDICTION_DATA( CWeaponThunder5 )
#ifdef CLIENT_DLL
	DEFINE_PRED_FIELD( m_iInSpecialReload, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
#endif
END_PREDICTION_DATA()

LINK_ENTITY_TO_CLASS( weapon_thunder5, CWeaponThunder5 );
PRECACHE_WEAPON_REGISTER( weapon_thunder5 );



CWeaponThunder5::CWeaponThunder5()
{
	m_flPumpTime = 0;
}

void CWeaponThunder5::PrimaryAttack()
{
...
void CWeaponThunder5::SecondaryAttack()
{	
	CSDKPlayer *pPlayer = GetPlayerOwner();
	if ( !pPlayer )
		return;
...
void CWeaponThunder5::WeaponIdle()
{
	CSDKPlayer *pPlayer = GetPlayerOwner();
...
acttable_t CWeaponThunder5::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE( CWeaponThunder5 );
